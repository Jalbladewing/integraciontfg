...
public class Mensajes_administrador extends Mensajes_administrador_Ventana implements View 
{
	@Autowired
	private UsuariohasMensajeRepository usuarioMensajeRepo;
	
	public static String VIEW_NAME = "mensajesAdministrador";
	private List<UsuariohasMensaje> mensajesL;
	
	public Mensajes_administrador()
	{
